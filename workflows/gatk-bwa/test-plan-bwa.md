...
```bash
cd /home/ec2-user/project-mosquito-wgs/workflows/gatk-bwa
...
docker tag mosquito-wgs-gatk-bwa:latest \
  <ACCOUNT_ID>.dkr.ecr.<REGION>.amazonaws.com/mosquito-wgs-gatk-bwa:latest
