...
| Component | Detail |
|---|---|
| Compute Environment | `mosquito-wgs-gpu-parabricks`, MANAGED, g5.12xlarge On-Demand |
| Job Queue | `mosquito-wgs-gpu-queue` |
| Job Definition | `parabricks-germline:2` (48 vCPU, 180 GB, 4 GPU) |
| ECR Image | `ACCOUNT_ID.dkr.ecr.ap-northeast-2.amazonaws.com/parabricks:4.3.1-1` |
