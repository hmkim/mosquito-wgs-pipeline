...
| 항목 | 상태 | 위치 |
|---|---|---|
| ECR 이미지 | `parabricks:4.3.1-1` ✅ | `ACCOUNT_ID.dkr.ecr.ap-northeast-2.amazonaws.com` |
| FASTQ R1 | 9.9 GB ✅ | `s3://mosquito-wgs-data-.../raw/mosquito-wgs/SRR6063611/SRR6063611_R1.fastq.gz` |
| FASTQ R2 | 10.1 GB ✅ | `s3://mosquito-wgs-data-.../raw/mosquito-wgs/SRR6063611/SRR6063611_R2.fastq.gz` |
| Reference tarball | 3.3 GB ✅ | `s3://mosquito-wgs-data-.../reference/mosquito/AaegL5/AaegL5.fasta.tar` |
| EC2 인스턴스 | `<EC2_INSTANCE_ID>` ✅ | ap-northeast-2 |
...
- **Job Role**: S3 read/write 권한 (`mosquito-wgs-data-*` 버킷)
