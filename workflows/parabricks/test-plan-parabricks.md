...
The existing `mosquito-wgs-omics-workflow-role` should work if it already has S3 and ECR permissions. Verify it can access the new `parabricks` ECR repository.
